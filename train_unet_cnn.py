...
parser.add_argument("--config_json", default="train_config.json", help="Filename for training config json.")
...
with Progress() as progress:
    ...
    for b in range(num_batches):
        ...
        torch.save(model.state_dict(), f'training_log/3d_weights_{cur_date}.pth')
